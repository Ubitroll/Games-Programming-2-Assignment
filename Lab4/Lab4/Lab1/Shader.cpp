...
void Shader::init(const std::string& filename)
{
	...
	shaders[0] = CreateShader(LoadShader("Z:\\Lab4\\Lab4\\res\\\shader.vert"), GL_VERTEX_SHADER); // create vertex shader
	shaders[1] = CreateShader(LoadShader("Z:\\Lab4\\Lab4\\res\\shader.frag"), GL_FRAGMENT_SHADER); // create fragment shader
